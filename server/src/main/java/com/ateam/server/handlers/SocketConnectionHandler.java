...
public class SocketConnectionHandler extends TextWebSocketHandler {
        ...
        throws Exception
    {
        ...
        broadcastMessageExceptSender(message, session);
    }

		private void broadcastMessageExceptSender(WebSocketMessage<?> message, WebSocketSession sender) {
			for (WebSocketSession webSocketSession : webSocketSessions) {
				if (webSocketSession != sender) {
					try {
