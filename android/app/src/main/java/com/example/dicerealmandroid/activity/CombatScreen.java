				...
				try {
					...
					for (Stat stat : sortedStats) {
						...
						if (StatsMap.getStatText(stat) == "Armour Class") {
							...
							currentStat.setText(
									StatsMap.getStatText(stat).substring(0, 3) + ": " + player.getStat(stat));
						}
				...
				if (skills != null) {
					...
					skillButtons.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							CardAdapter cardAdapter = new SpellCardAdapter(CombatScreen.this, skillList, "Spell",
									combatSh, CombatScreen.this);
				...
				if (Potions_Scroll != null) {
					...
					Itembutton.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							CardAdapter cardAdapter = new InventoryCardAdapter(CombatScreen.this,
									Potions_Scrolllist, "Item", combatSh, CombatScreen.this);
