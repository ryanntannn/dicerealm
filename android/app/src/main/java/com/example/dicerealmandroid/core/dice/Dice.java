package com.example.dicerealmandroid.core.dice;


import com.example.dicerealmandroid.core.strategy.RandomStrategy;

public class Dice {
    private int sides;
    private transient RandomStrategy randomStrategy = new DefaultRandomStrategy();
